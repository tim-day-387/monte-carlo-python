...
class mlRolloutPlayer(player.player):
    # Constructor
    def __init__(self, name, model, TIME_GIVEN, timeAlloc = False):
        # Inherit
        super().__init__(name)
        ...
        while time.process_time() < terminateBy:
            ...
            while time.process_time() < terminateBy:
                ...
                if output[0] == True:
                    ...
                    adv = results - max(output[3],output[5]) 
